...
This application will create a simple reading list by asking for books you have read and storing them in a simple relational repository. We'll continue building upon the Spring Boot application we built in link:../lab01/lab01.adoc[Lab 1].  The first stereotype we'll need is the domain model itself, which is `City`.
